...
class Domain:
    def __init__(
        self, grids: Sequence[Union[UniformPeriodicGrid, NonUniformPeriodicGrid]]
    ):
...
class DifferenceUniformGrid(Difference):
    ...
    def _make_stencil(self, grid: UniformPeriodicGrid) -> None:
    ...
    def _build_matrix(self, grid: UniformPeriodicGrid) -> None:
        shape = [grid.N] * 2
